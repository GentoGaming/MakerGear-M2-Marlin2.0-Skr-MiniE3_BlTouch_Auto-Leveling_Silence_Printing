...
#define STRING_CONFIG_H_AUTHOR "(Maroun, Makergear M2)" // Who made the changes.
 ...
 *                                      X, Y, Z, E0 [, E1[, E2...]]
 */
#define DEFAULT_AXIS_STEPS_PER_UNIT   {88.88,88.88,400,471.5}  // default steps per unit for Ultimaker //v000 9/24/2015
 ...
 *                                      X, Y, Z, E0 [, E1[, E2...]]
 */
#define DEFAULT_MAX_ACCELERATION      {900,900,30,2000}    // X, Y, Z, E maximum start speed for accelerated moves. E default values are good for Skeinforge 40+, for older versions raise them a lot. -- Changed these from (9000,9000,100,10000) to (900,1000,30,2000) as per Scott's requests - 1/12/2016 Josh
...
#define CLASSIC_JERK
  ...
  #define LIMITED_JERK_EDITING        // Limit edit via M205 or LCD to DEFAULT_aJERK * 2
    ...
    #define MAX_JERK_EDIT_VALUES { 4, 4, 0.4, 1 } // ...or, set your own edit limits
  #endif
#endif
 ...
 */
#define NOZZLE_TO_PROBE_OFFSET {20,2,-3.27}
...
#define Z_CLEARANCE_DEPLOY_PROBE   10 // Z Clearance for Deploy/Stow
#define Z_CLEARANCE_BETWEEN_PROBES  5 // Z Clearance between probe points  -- This is it 
